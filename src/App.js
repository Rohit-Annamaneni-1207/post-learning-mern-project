...
function App() {
  ...
  const registerHandler = (event)=>{
    ...
    regResponse.then((regResponse)=>{
      ...
      axios({
        method: 'post',
        url: "http://localhost:5000/assignToken", 
        data: data}
        );
  ...
  const loginHandler = (event)=>{
    ...
    loginResponse.then((loginResponse)=>{
      ...
      axios({
        method: "get",
        url: "http://localhost:5000/userSchedules",
  ...
  const handleUnload = (event)=>{
    ...
    axios({
      method: 'post',
      url: "http://localhost:5000/removeToken",
      data: data
  ...
  const handleNewSchedule = (event)=>{
    ...
    axios({
      method: 'post',
      url: "http://localhost:5000/new_schedule",
      data: data
  ...
  const delete_schedule = (schedule_id)=>{
    ...
    axios({
      method: 'post',
      url: "http://localhost:5000/delete_schedule",
